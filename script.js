/*
  ...
  - naloge se pri ponovnem igranju pomešajo
...
const allChallenges = [
  ...
  },
  {
    ...
    correct: 1,
    hint: "Poglej opravila, ki so že prikazana, in poišči tisto, ki smiselno sledi dejavnosti po vremenu ter pride pred umivanje zob in spanje.",
...
function resetGame() {
  ...
  // Črke za geslo se pri vsakem novem igranju premešajo.
  // Učenec jih mora na koncu pravilno urediti v geslo LOGIKA.
